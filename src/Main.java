...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Util.executeTest("testdata/aleatorio_10000.csv", SortAlgorithm.QUICK_SORT);
            System.out.println(" ");

            Util.executeTest("testdata/crescente_100.csv", SortAlgorithm.QUICK_SORT);
            Util.executeTest("testdata/crescente_1000.csv", SortAlgorithm.QUICK_SORT);
            Util.executeTest("testdata/crescente_10000.csv", SortAlgorithm.QUICK_SORT);
            System.out.println(" ");
